...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("asslamualaikum\nkakak");
        System.out.println("Nama saya aulia  Kelas \"c\"");
        System.out.println("Nim\t:D0225029");
        System.out.println("umu\br:19");
        System.out.println("gender \'p\'");
